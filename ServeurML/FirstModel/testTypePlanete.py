...
def import_images_and_assign_labels(
    ...
    for file in os.listdir(folder):
        ...
        im = im.convert("RGB")
        im_arr = np.array(im)
        im_arr = np.reshape(im_arr, (20 * 20 * 3))
        X.append(im_arr)
        Y.append(label)


def import_dataset():
    dataset_folder = "C:/Users/33660/Documents/dataset"
...
def run():
    ...
    path_to_dll = "C:/Users/33660/CLionProjects/projetAnnuel2/cmake-build-debug/projetAnnuel2.dll"
    ...
    mylib.savePMC(model, b'testTypePlaneteModel')
